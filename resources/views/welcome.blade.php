...
<html>
<head>
    <title> Gurudevloper</title>
    <link href="{{url('files/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all">
    <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
    <script src="{{url('js/jquery-1.11.0.min.js')}}"></script>
    <!-- Custom Theme files -->
    <link href="{{url('files/css/style.css')}}" rel="stylesheet" type="text/css" media="all">
    <!-- Custom Theme files -->
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <!--Google Fonts-->
    <link href="{{url('//fonts.googleapis.com/css?family=Aladin')}}" rel='stylesheet' type='text/css'>
    <link href="{{url('//fonts.googleapis.com/css?family=Oxygen')}}" rel='stylesheet' type='text/css'>
    <!--google fonts-->
    ...
    <!-- //end-smoth-scrolling -->
    <!-- animated-css -->
    <link href="{{url('files/css/animate.css')}}" rel="stylesheet" type="text/css" media="all">
    <script src="{{url('files/js/easing.js')}}"></script>
    <script>
        new WOW().init();
    </script>
    <!-- animated-css -->
    <script type="text/javascript" src="{{url('files/js/main.js')}}"></script>
    ...
    <div class="container">
        <div class="banner-main">
            <div class="logo wow bounceInLeft" data-wow-delay="0.1s">
                <h1><a href="{{url('/')}}">Gurudeveloper</a></h1>
            </div>
            <div class="top-navg">
                ...
                <div id="m_nav_container" class="m_nav">
                    <ul id="m_nav_list" class="m_nav">
                        <li class="m_nav_item" id="m_nav_item_1"> <a href="{{url('/')}}">Home</a> </li>
                        <li class="m_nav_item" id="moble_nav_item_2"> <a href="{{url("/about")}}">About </a> </li>
                        <li class="m_nav_item" id="moble_nav_item_3"> <a href="{{url("/services")}}">Services</a> </li>
                        <li class="m_nav_item" id="moble_nav_item_4"> <a href="{{url("/gallery")}}"> Gallery </a> </li>
                        <li class="m_nav_item" id="moble_nav_item_5"> <a href="{{url("/contact")}}"> Contact </a> </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="changer-main">
                ...
                <div class="about-block">
                    ...
                    <div class="changer-right wow bounceInRight" data-wow-delay="0.1s">
                        <img src="{{url('files/images/a1.png')}}" alt="">
                    </div>
                    <div class="clearfix"> </div>
                    <div class="ch-bott1">
                ...
                <div class="about-block-snd">
                    <div class="changer-left-snd wow bounceInLeft" data-wow-delay="0.1s">
                        <img src="{{url('files/images/a3.png')}}" alt="">
                    </div>
        ...
        <div class="service-main">
            ...
            <div class="service-bottom">
                <div class="col-md-5 ser-left wow bounceInLeft" data-wow-delay="0.1s">
                    <img src="{{url('files/images/ser-lft.png')}}" alt="">
                </div>
    ...
    <div class="container">
        <div class="gallery-main">
            ...
            <div class="gallery-bottom">
                <!---->
                <ul id="flexiselDemo3">
                    <li><img src= "{{url('files}}" class="img-responsive" alt=""/></li>
                    <li><img src="{{url('files/images/ap2.png')}}" class="img-responsive" alt=""/></li>
                    <li><img src="{{url('files/images/ap3.png')}}" class="img-responsive" alt=""/></li>
                    <li><img src="{{url('files/images/ap2.png)}}" class="img-responsive" alt=""/></li>
                </ul>
            </div>
            <script type="text/javascript">
            ...
            <script type="text/javascript" src="{{url('files/js/jquery.flexisel.js')}}"></script>
        </div>
    </div>
</div>
<!--gallery end here-->
        ...
        <div class="features-main">
            ...
            <div class="features-bottom">
                <div class="col-md-6 features-left">
                    <div class="fea-block wow bounceInLeft" data-wow-delay="0.1s">
                ...
                <div class="col-md-6 features-right">
                    <div class="fea-block-rit wow bounceInRight" data-wow-delay="0.1s">
...
<div class="quotation wow bounceInLeft" data-wow-delay="0.1s">
    <div class="container">
        <div class="quotation-main">
            <img src="{{url('files/images/quota.png')}}" alt="">
    ...
    <div class="container">
        <div class="contact-main">
            ...
            <div class="contact-bottom">
                <div class="contact-left wow bounceInLeft" data-wow-delay="0.1s">
                    <h4>Contact Info</h4>
                    <form>
                        <input type="text" name="name" placeholder="Name">
                        <input type="text" name="email" placeholder="Email">
                        <textarea name="message" placeholder="Subject\Message" required=""></textarea>
                        <input type="submit" value="Send">
                    </form>
                </div>
                <div class="contact-right wow bounceInRight" data-wow-delay="0.1s">
                    <div class="contact-rit-info">
                        <h4>Address</h4>
                        <p>last floor of the </p>
                        <p>wuse 2 oppsite chole's cupcakes </p>
                        <p>P.O.Box </p>
                        <p>Nigeria</p>
...
<div class="copy-right">
    <div class="container">
        <div class="copy-rights-main wow zoomIn" data-wow-delay="0.1s">
            <p>© 2016 Gurudeveloper. All Rights Reserved | Design by odianjo chukwuka </p>
        </div>
    </div>
    <script type="text/javascript">
