...
<head>
    ...
    <script src="{{url('files/js/jquery-1.11.0.min.js')}}"></script>
    <!-- Custom Theme files -->
            ...
            <div class="top-navg">
                ...
                <div id="m_nav_container" class="m_nav">
                    <ul id="m_nav_list" class="m_nav">
                        ...
                        <li class="m_nav_item" id="moble_nav_item_3"> <a href="#services">Services</a> </li>
                        <li class="m_nav_item" id="moble_nav_item_4"> <a href="#gallery">Gallery</a> </li>
                        <li class="m_nav_item" id="moble_nav_item_5"> <a href="#contact">Contact </a> </li>
                    </ul>
                </div>
            </div>
